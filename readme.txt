...
Installing "H Tag Checker" can be done either by searching for "H Tag Checker" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
