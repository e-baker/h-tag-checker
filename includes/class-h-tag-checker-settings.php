...
class H_Tag_Checker_Settings {
	...
	public function add_settings_link ( $links ) {
		$settings_link = '<a href="options-general.php?page=' . $this->parent->_token . '_settings">' . __( 'Settings', 'h-tag-checker' ) . '</a>';
	...
	public function settings_page () {
		...
		$html = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			$html .= '<h2>' . __( 'Plugin Settings' , 'h-tag-checker' ) . '</h2>' . "\n";
			...
			$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
				...
				$html .= '<p class="submit">' . "\n";
					...
					$html .= '<input name="Submit" type="submit" class="button-primary" value="' . esc_attr( __( 'Save Settings' , 'h-tag-checker' ) ) . '" />' . "\n";
				$html .= '</p>' . "\n";
			$html .= '</form>' . "\n";
		$html .= '</div>' . "\n";
